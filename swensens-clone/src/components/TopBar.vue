<template>
	<section>
		<router-link to="/">
			<img src="https://seeklogo.com/images/S/swensen-s-logo-B0148BB776-seeklogo.com.png" />
		</router-link>
		<div class="list">
			<div class="location">
				<router-link to="/">
			...
			<span class="btn" v-if="!userName">
				<router-link to="/register">
					<button class="reg">สมัครสมาชิก</button>
				</router-link>
				<router-link to="/login">
					<button class="login">เข้าสู่ระบบ</button>
				</router-link>
			</span>
			<span class="btn" v-else @click="logOut">
